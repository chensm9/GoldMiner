...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    faceAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("miner-face-whistle-0.png"));
    faceAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("miner-face-whistle-1.png"));
    faceAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName("miner-face-smile.png"));
    faceAnimation->setDelayPerUnit(0.2);
    ...
    caveAnimation->setDelayPerUnit(0.2);
    ...
    for (int i = 0; i < totalFrames; i++) {
        sprintf(frameName, "pulled-diamond-%d.png", i);
    ...
    for (int i = 0; i < totalFrames; i++) {
        sprintf(frameName, "pulled-gem-mouse-%d.png", i);
